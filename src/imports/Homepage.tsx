import svgPaths from "./svg-07zsnc9e9u";
...
function NumberWrap() {
  return (
    <div className="content-stretch flex font-['Darker_Grotesque:Bold',sans-serif] font-bold gap-[10px] items-center justify-center leading-[0] relative shrink-0 text-[#ed5128] text-[20px] whitespace-nowrap" data-name="Number Wrap">
      ...
      <div className="flex flex-col justify-center relative shrink-0" id="node-1_164">
        <p className="leading-[1.1]">about</p>
      </div>
    </div>
  );
  //</p></div><div className="flex flex-col justify-center relative shrink-0" id="node-1_164"><p className="leading-[1.1]">about</p></div></div>);
  //</p></div><div className="flex flex-col justify-center relative shrink-0" id="node-1_164"><p className="leading-[1.1]">about</p></div></div>);
...
function Headline() {
  return (
    <div className="content-stretch flex font-['Darker_Grotesque:Bold',sans-serif] font-bold gap-[10px] items-center leading-[0] opacity-80 relative shrink-0 text-[#ed5128] text-[20px] whitespace-nowrap" data-name="headline">
      ...
      <div className="flex flex-col justify-center relative shrink-0" id="node-1_176">
        <p className="leading-[1.1]">past achievements</p>
      </div>
    </div>
  );
  //</p></div><div className="flex flex-col justify-center relative shrink-0" id="node-1_176"><p className="leading-[1.1]">past achievements</p></div></div>);
  //</p></div><div className="flex flex-col justify-center relative shrink-0" id="node-1_176"><p className="leading-[1.1]">past achievements</p></div></div>);
...
function Headline1() {
  return (
    <div className="content-stretch flex font-['Darker_Grotesque:Bold',sans-serif] font-bold gap-[10px] items-center leading-[0] opacity-80 relative shrink-0 text-[20px] whitespace-nowrap" data-name="headline">
      ...
      <div className="flex flex-col justify-center relative shrink-0" id="node-1_196">
        <p className="leading-[1.1]">our services</p>
      </div>
    </div>
  );
  //</p></div><div className="flex flex-col justify-center relative shrink-0" id="node-1_196"><p className="leading-[1.1]">our services</p></div></div>);
  //</p></div><div className="flex flex-col justify-center relative shrink-0" id="node-1_196"><p className="leading-[1.1]">our services</p></div></div>);
...
function Headline2() {
  return (
    <div className="content-stretch flex font-['Darker_Grotesque:Bold',sans-serif] font-bold gap-[10px] items-center leading-[0] opacity-80 relative shrink-0 text-[20px] text-white whitespace-nowrap" data-name="headline">
      ...
      <div className="flex flex-col justify-center relative shrink-0" id="node-1_210">
        <p className="leading-[1.1]">what’s happening</p>
      </div>
    </div>
  );
  //</p></div><div className="flex flex-col justify-center relative shrink-0" id="node-1_210"><p className="leading-[1.1]">what’s happening</p></div></div>);
  //</p></div><div className="flex flex-col justify-center relative shrink-0" id="node-1_210"><p className="leading-[1.1]">what’s happening</p></div></div>);
...
function Headline3() {
  return (
    <div className="content-stretch flex font-['Darker_Grotesque:Bold',sans-serif] font-bold gap-[10px] items-center leading-[0] opacity-80 relative shrink-0 text-[20px] whitespace-nowrap" data-name="headline">
      ...
      <div className="flex flex-col justify-center relative shrink-0" id="node-1_251">
        <p className="leading-[1.1]">media speaking</p>
      </div>
    </div>
  );
  //</p></div><div className="flex flex-col justify-center relative shrink-0" id="node-1_251"><p className="leading-[1.1]">media speaking</p></div></div>);
  //</p></div><div className="flex flex-col justify-center relative shrink-0" id="node-1_251"><p className="leading-[1.1]">media speaking</p></div></div>);
